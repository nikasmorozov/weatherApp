...
},{}],"latinise_utility/index.js":[function(require,module,exports) {
...
latiniseFn = String.prototype.latinise = function () {
...
var _require2 = require('./latinise_utility'),
    latinise = _require2.latinise;

var searchGroup = createDomElement('div', {
  id: 'searchGroup'
});
var cityToSearch = createDomElement('input', {
  id: 'cityToSearch'
});
cityToSearch.placeholder = 'paieška';
var isTemperatureAboveZero = null;
var cityData = null;
var linkToFetch = null;
...
function filterCities() {
  var filteredCities = cityData.filter(function (value) {
  ...
  var _loop = function _loop() {
    var locationToRender = createDomElement('button', {});
...
function renderWeatherData() {
  var city = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'vilnius';
  linkToFetch = "https://cors-anywhere.herokuapp.com/http://api.meteo.lt/v1/places/".concat(city, "/forecasts/long-term");
  ...
  fetch(linkToFetch, {
    ...
    isTemperatureAboveZero = data.forecastTimestamps[0].airTemperature > 0; // changes the color scheme to opposite:
    ...
    var nextHoursWeather = createDomElement('div', {
    ...
    for (i = 0; i <= 12; i++) {
      ...
      var timeStamp = createDomElement('div', {
        className: 'timeStamp'
      });
      var utcTime = createDomElement('h4', {
        textContent: data.forecastTimestamps[i + 2].forecastTimeUtc.slice(11, 16)
      });
      utcTime.classList.add('utcTime');
      var weatherIcon = createDomElement('div', {});
      ...
      if (i == 0) {
        var cityName = createDomElement('h3', {
          textContent: data.place.name
        });
        addToDom(timeStamp, cityName);
        var weatherConditions = createDomElement('h4', {
    ...
    var sourceMentioning = createDomElement('p', {
...
function geolocation() {
  ...
  function success(pos) {
    var crd = pos.coords; // console.log(`Latitude : ${crd.latitude}`);
